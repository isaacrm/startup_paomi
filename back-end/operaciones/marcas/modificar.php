...
$conexion = conectaDB();
if(!empty($_POST)) {
    $sql = $conexion->prepare("update marcas set nombre='" . $_POST['nombre'] . "', descripcion='" . $_POST['desc'] . "' where id_marca=" . $_POST['ids']);
    $sql->execute();
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container" style="overflow-Y:scroll; height:auto; width:100%;">
                <?php
                $db = conectaDB();
                $sql = $db->prepare("Select * from marcas where id_marca=".$_GET['id']);
                $sql->execute();
