    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table class="table table-striped table-bordered table-hover" >
                ...
                $sql = $conexion->prepare("select count(*) from marcas");
                $sql->execute();
                ...
                $sql = $conexion->prepare('select * from marcas where nombre LIKE "%' . $_POST['filtro'] . '%"  LIMIT '. (($paginacion->get_page() - 1) * $filas) . ', ' . $filas);
                $sql->execute();
                    ...
                    echo '
		 				<tbody>
					        <tr>
					            ...
					            <td><p><a href="modificar.php?id='.$filas['id_marca'].'" class="btn btn-warning">Modificar</a> <a href="eliminar.php?id='.$filas['id_marca'].'" class="btn btn-danger">Eliminar</a></p></td>
					        </tr>
					    </tbody>
		 			';
                }
