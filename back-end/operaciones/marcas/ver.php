	...
	<section class="content">
		<a href="ingresar.php" class="btn btn-primary">Nuevo</a>
			<table class="table table-striped table-bordered table-hover" >
				...
				$sql = $conexion->prepare('select * from marcas  LIMIT '. (($paginacion->get_page() - 1) * $filas) . ', ' . $filas);
				$sql->execute();
					...
					echo '
		 				<tbody>
					        <tr>
					            ...
					            <td><p><a href="modificar.php?id='.$filas['id_marca'].'" class="btn btn-warning">Consultar/Modificar</a> <a href="eliminar.php?id='.$filas['id_marca'].'" class="btn btn-danger">Eliminar</a></p></td>
					        </tr>
					    </tbody>
		 			';
				}
